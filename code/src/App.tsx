  ...
  <AnimatePresence>
    {isOpen && (
      <motion.div
        ...
        className="absolute top-[50px] right-4 z-50 backdrop-blur-lg rounded-xl shadow-lg overflow-hidden w-64 border dark:border-white/10 border-white/20 dark:bg-gray-900/95 bg-white/95"
      >
        <div className="p-2">
          {/* 导航链接 */}
